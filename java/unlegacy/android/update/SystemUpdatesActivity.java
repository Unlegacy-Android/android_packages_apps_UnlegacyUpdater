...
public class SystemUpdatesActivity extends Activity implements OnRequestPermissionsResultCallback {
    ...
    */
    ...
    private void loadPrefs() {
        if(!mPrefs.getString(UpdateInfo.VERSION, "").isEmpty())
        {
            updateInfo = new UpdateInfo(
                    ...
                    new Date(mPrefs.getLong(UpdateInfo.DATE, 0)),
                    mPrefs.getLong(UpdateInfo.SIZE, 0)
            );
        }
    ...
    private void savePrefs() {
        if (updateInfo!=null)
            mPrefs.edit()
                    ...
                    .putString(UpdateInfo.VERSION, updateInfo.getVersion())
                    .putString(UpdateInfo.DESCRIPTION, updateInfo.getDescription())
                    .putString(UpdateInfo.URL, updateInfo.getUrl())
                    .putString(UpdateInfo.MD5, updateInfo.getMd5())
                    .putLong(UpdateInfo.DATE, updateInfo.getDate().getTime())
                    .putLong(UpdateInfo.SIZE,updateInfo.getFileSize())
                    .apply();
    }
        ...
        switch(this.state) {
            ...
            case UPDATE_AVAILABLE:
                setUiViews(
                        ...
                        (updateInfo.getFileSize()/1048576)+"MB",
                        false
                );
                break;

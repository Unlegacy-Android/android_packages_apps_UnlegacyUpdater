...
public class SystemUpdateNotify {
    ...
    public static void notifyUpdateAvailable(Context context, Intent updateIntent) {

        NotificationCompat.BigTextStyle style = new NotificationCompat.BigTextStyle()
                .setBigContentTitle(context.getString(R.string.system_update_update_available_notification_title))
                .bigText(context.getString(R.string.system_update_download_button_text));

        NotificationCompat.Builder builder = createBaseContentBuilder(context, updateIntent)
                .setContentTitle(context.getString(R.string.system_update_update_available_notification_title))
                .setContentText(context.getString(R.string.system_update_activity_title))
                .setTicker(context.getString(R.string.system_update_update_available_notification_title))
                .setStyle(style)
                .addAction(R.mipmap.ic_dialog_system_update,
                        context.getString(R.string.system_update_download_button_text),
                        openSystemUpdateActivity(context));

        ((NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE))
                .notify(R.string.system_update_update_available_notification_title, builder.build());
    }
